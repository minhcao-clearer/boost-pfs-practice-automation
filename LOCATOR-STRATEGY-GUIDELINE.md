...
_Áp dụng cho các tất cả các projects của Clearer.io_
...
page
  .locator('xpath=//td[normalize-space(text())="Error"]/ancestor::tr')
...
_Guideline này viết cho người mới bắt đầu automation. Nếu có thuật ngữ nào chưa rõ, hỏi lead hoặc người review PR — đừng ngại hỏi, ai cũng bắt đầu từ manual cả._
